 ...
 */
function custom_block_core_latest_posts_get_excerpt_length() {
	global $block_core_latest_posts_excerpt_length;
...
function custom_render_block_core_latest_posts( $attributes ) {
	...
	add_filter( 'excerpt_length', 'custom_block_core_latest_posts_get_excerpt_length', 20 );
	...
	remove_filter( 'excerpt_length', 'custom_block_core_latest_posts_get_excerpt_length', 20 );
...
add_action( 'init', 'custom_register_block_core_latest_posts' );

...
?>
    ...
    <header class="glossary__header">
        ...
        <?php echo '<p>'. __('Technical terms, public policies, and initiatives for achieving zero deforestation and conserving forests explained with a simple click, in a quick summary or in full.', 'plenamata').'</p>'?>
                        ...
                        <div class="glossary__entry-detail">
                            ...
                            <p>
                                <a href="<?= get_permalink( $entry->ID ) ?>">
                                    <?= __( 'Access full entry', 'plenamata' ) ?>
                                </a>
                            </p>
                        </div>
                    </details>
